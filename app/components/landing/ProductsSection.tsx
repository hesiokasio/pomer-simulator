...
const products = [
  {
    ...
    altText: "سطل ۲۰ کیلویی چسب کاشی و سرامیک پرومر"
  },
  {
    id: 2,
    title: "چسب کاشی پلیمری",
    ...
    altText: "چسب کاشی پلیمری ۵ کیلویی پرومر"
  },
  {
    id: 3,
    ...
    altText: "پودر بندکشی و ترمیم درز کاشی ۵۰۰ گرمی پرومر"
  }
];
  ...
  return (
    <section className={styles.productsSection}>
      <div className={styles.container}>
        ...
        >
          <h2 className={styles.title}>محصولات پرومر</h2>
          <p>
