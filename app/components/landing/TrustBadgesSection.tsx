...
// لیست ویژگی‌های کلیدی سئوشده با آیکون‌های کاملاً مرتبط و اختصاصی
const badges = [
  {
  ...
  },
  {
    ...
    icon: (
      <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
        {/* آیکون کاشی‌های به هم پیوسته و مستحکم */}
  ...
  },
  {
    ...
    icon: (
      <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
        {/* آیکون زمان‌سنج برای نشان دادن سرعت و راحتی */}
