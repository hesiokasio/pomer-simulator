...
const badges = [
  ...
  {
    title: "چسبندگی بالا بدون ترک و انقباض",
    icon: (
      <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
  ...
  {
    title: "مقاوم در برابر شوینده‌های اسیدی",
    icon: (
      <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
  ...
  {
    title: "بندکشی آنتی‌باکتریال و ضد جرم",
    icon: (
      <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
  ...
  {
    title: "اجرای آسان بدون نیاز به نصاب",
    icon: (
      <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
...
export default function TrustBadgesSection() {
  return (
    <section className={styles.badgesSection}>
      <h2 className="sr-only" style={{ display: 'none' }}>مزایای کلیدی پودر بندکشی پرومر</h2>
